...
//createSlice - об'єкт який працює с певною частиною стану гдобального стану
const counterSlice = createSlice({
    ...
    reducers:{// об'єкт який повертає набір методів, який буде працювати з станом нашого counter
